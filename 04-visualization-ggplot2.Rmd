...
> ggplot(data = metadata, aes(x = species_id, y = weight)) +
...
grey_theme <- theme(axis.text.x = element_text(colour = "grey20", size = 12, angle = 90, hjust = 0.5, vjust = 0.5),
                          axis.text.y = element_text(colour = "grey20", size = 12),
                          text = element_text(size = 16))
ggplot(metadata, aes(x = species_id, y = hindfoot_length)) +
    geom_boxplot() +
    grey_theme
```
...
spp_weight_boxplot <- ggplot(data = metadata, aes(x = species_id, y = weight)) +
  geom_boxplot() +
